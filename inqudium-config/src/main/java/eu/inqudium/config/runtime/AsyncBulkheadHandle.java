 ...
 * paradigm-tagged compile-time identity ({@link AsyncTag}) and the
 ...
 * {@link DefaultAsync#bulkhead(String)} /
 * {@link DefaultAsync#findBulkhead(String)}.</p>
 *
 * @since 0.10.0
 */
final class AsyncBulkheadHandle implements BulkheadHandle<AsyncTag> {

    private final BulkheadComponent component;

    AsyncBulkheadHandle(BulkheadComponent component) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AsyncBulkheadHandle other)) return false;
