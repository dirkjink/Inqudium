    ...
    private static MethodDispatchEntry buildDecorated(
        ...
        return switch (paradigm) {
            ...
            case eu.inqudium.core.element.paradigm.ImperativeTag i ->
                    // The classifier never produces ImperativeTag — it
                    // returns SyncTag/AsyncTag for imperative methods.
                    // Reaching this case would indicate the deprecated
                    // ImperativeTag was injected by a hand-built plan;
                    // reject it loudly so the call site surfaces. The
                    // branch goes away in Q.7 when ImperativeTag is
                    // removed from ParadigmTag's permits.
                    throw new IllegalStateException(
