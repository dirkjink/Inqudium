...
public final class CircuitBreakerConfig implements InqConfig {
    ...
    public static CircuitBreakerConfig ofDefaults() { return DEFAULTS; }
    ...
    public static final class Builder {
        ...
        public Builder failureRateThreshold(float threshold) { this.failureRateThreshold = threshold; return this; }
        public Builder slowCallRateThreshold(float threshold) { this.slowCallRateThreshold = threshold; return this; }
        public Builder slowCallDurationThreshold(Duration duration) { this.slowCallDurationThreshold = Objects.requireNonNull(duration); return this; }
        public Builder slidingWindowType(SlidingWindowType type) { this.slidingWindowType = Objects.requireNonNull(type); return this; }
        public Builder slidingWindowSize(int size) { this.slidingWindowSize = size; return this; }
        public Builder minimumNumberOfCalls(int min) { this.minimumNumberOfCalls = min; return this; }
