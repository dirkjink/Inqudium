 ...
 *
 * <p>The {@link eu.inqudium.core.paradigm.ParadigmTag}
 * sealed interface and its sub-family interfaces
 * ({@link eu.inqudium.core.paradigm.ReactiveTag},
 * {@link eu.inqudium.core.paradigm.RxJava3Tag},
 * {@link eu.inqudium.core.paradigm.CoroutinesTag})
 * classify the programming style of a resilience-protected
 * method. The top-level {@link eu.inqudium.core.paradigm.SyncTag}
 * and {@link eu.inqudium.core.paradigm.AsyncTag} cover
