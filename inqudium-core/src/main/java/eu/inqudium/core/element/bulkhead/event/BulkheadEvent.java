...
public abstract class BulkheadEvent extends InqEvent {
    protected BulkheadEvent(long stackId, long callId, String elementName, Instant timestamp) {
        super(stackId, callId, elementName, InqElementType.BULKHEAD, timestamp);
    }
}
