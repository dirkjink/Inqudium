...
class ImperativeCircuitBreakerTest {
    ...
    class FailureHandling {
        ...
        void should_reject_calls_with_circuit_breaker_exception_when_open() {
            ...
            // Open the circuit
            for (int i = 0; i < 3; i++) {
                try { cb.execute(() -> { throw new RuntimeException("fail"); }); } catch (Exception e) {}
            }
    ...
    class ExceptionFiltering {
        ...
        void should_not_count_ignored_exceptions_as_failures() {
            ...
            for (int i = 0; i < 5; i++) {
                try { cb.execute(() -> { throw new IllegalArgumentException("ignored"); }); } catch (Exception e) {}
            }
        ...
        void should_only_count_configured_exception_types_as_failures() {
            ...
            for (int i = 0; i < 5; i++) {
                try { cb.execute(() -> { throw new RuntimeException("not recorded"); }); } catch (Exception e) {}
            }
