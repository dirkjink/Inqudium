    ...
    class Events {
        ...
        void should_receive_success_events_on_fast_calls() {
            ...
            var tl = TimeLimiter.of("shippingService", TimeLimiterConfig.builder()
                    .timeoutDuration(Duration.ofSeconds(2))
                    .build());
            var successEvents = new java.util.ArrayList<eu.inqudium.core.timelimiter.event.TimeLimiterOnSuccessEvent>();

            tl.getEventPublisher().onEvent(
                    eu.inqudium.core.timelimiter.event.TimeLimiterOnSuccessEvent.class,
                    successEvents::add);
        ...
        void should_receive_timeout_events_on_slow_calls() {
            ...
            var tl = TimeLimiter.of("shippingService", TimeLimiterConfig.builder()
                    .timeoutDuration(Duration.ofMillis(100))
                    .build());
            var timeoutEvents = new java.util.ArrayList<eu.inqudium.core.timelimiter.event.TimeLimiterOnTimeoutEvent>();

            tl.getEventPublisher().onEvent(
                    eu.inqudium.core.timelimiter.event.TimeLimiterOnTimeoutEvent.class,
                    timeoutEvents::add);
